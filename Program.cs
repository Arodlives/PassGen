...
builder.Services.AddHttpContextAccessor();  // AddHttpContextAccessor gives our views 
//direct access to session 
//so that session data doesn't need to be repeatedly passed into the ViewBag.
